...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container">
            <a class="navbar-brand" href="customer_dashboard.jsp"><h2>The Mega City <span>CAB</span></h2></a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="booking.jsp">Book A Cab</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="booking_success.jsp">View Booking & payment </a>
                    </li>
...
<div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background-image: linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5));"></div>
    ...
    <div class="home-content" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 1; text-align: center; color: #fff;">
        ...
        <p>Happy to meet you our valuable CUSTOMER.
        </p>
    </div>
</div>
    ...
    <section id="contact">
        ...
        <div class="container" >
            ...
            <div class="left-side">
                <h4>we are here to get your Enquiries and feedbacks so feel free to give your valuable feedbacks.</h4>
